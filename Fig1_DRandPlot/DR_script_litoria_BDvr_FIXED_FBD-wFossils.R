...
# scan in trees
trees1=scan("MamPhy_fullPosterior_BDvr_pcsFIXED_FBD-wFossils_all10k.trees", what="",sep="\n",quiet=TRUE,skip=0,comment.char="#") 
...
write.table(g_es_dr, "DR-matrix_MamPhy_BDvrFIXED_FBD-wFossils_all10k.txt")

pdf(file = "DRplot_BDvrFIXED_FBD-wFossils_5911extant-76fossil.pdf", height=8, width=8)
hist(unlist(g_es_dr), breaks=1000)
title(sub="DR - MamPhy 5911 spp, BDvrFixed - FBDwFossils, 10k trees")
dev.off()
...
for(i in 1:ntrees) {
	...
	write.tree(phy_drop, "MamPhy_fullPosterior_BDvr_pcsFIXED_FBD-wFossils_all10k_pruned4098spp.trees", append = TRUE)
	trees_drop[[i]] <- phy_drop
}

write.nexus(trees_drop, file="MamPhy_fullPosterior_BDvr_pcsFIXED_FBD-wFossils_all10k_pruned4098spp_nexus.trees")
write.nexus(trees, file="MamPhy_fullPosterior_BDvr_pcsFIXED_FBD-wFossils_all10k_nexus.trees")


trees_drop=scan("MamPhy_fullPosterior_BDvr_pcsFIXED_FBD-wFossils_all10k_pruned4098spp.trees", what="",sep="\n",quiet=TRUE,skip=0,comment.char="#") 
...
write.table(g_es_dr_DROP, "DR-matrix_MamPhy_BDvrFIXED_FBD-wFossils_all10k_pruned4098.txt")

pdf(file = "DRplot_BDvrFIXED_FBD-wFossils_4098spp.pdf", height=8, width=8)
hist(unlist(g_es_dr_DROP), breaks=1000)
title(sub="DR - MamPhy 4098 spp, BDvrFixed - FBD-wFossils, 10k trees")
dev.off()

###
# Now plot together...

pdf(file = "DRplot_BDvrFIXED_FBD-wFossils_compare5911v4098spp.pdf", height=8, width=8)
hist(unlist(g_es_dr), breaks=1000, border="black")
hist(unlist(g_es_dr_DROP), breaks=1000, border="red")

title(sub="DR - MamPhy compare 5911 vs 4098 spp, BDvrFixed - FBD-wFossils, 10k trees")
dev.off()
