...
#trees1=scan("MamPhy_fullPosterior_BDvr_pcsFIXED_FBD_all10k_pruned4098spp.trees", what="",sep="\n",quiet=TRUE,skip=0,comment.char="#") 
trees1=scan("MamPhy_fullPosterior_BDvr_pcsFIXED_NDexp_all10k_pruned4098spp.trees", what="",sep="\n",quiet=TRUE,skip=0,comment.char="#") 
...
#write.table(g_es_dr, "DR-matrix_MamPhy_BDvrFIXED_FBD_all10k.txt")
#write.table(g_es_dr, "DR-matrix_MamPhy_BDvrFIXED_FBD_all10k_pruned4098spp.txt")
write.table(g_es_dr, "DR-matrix_MamPhy_BDvrFIXED_NDexp_all10k_pruned4098spp.txt")

#pdf(file = "DRplot_BDvrFIXED_FBD_5911spp.pdf", height=8, width=8)
#hist(unlist(g_es_dr), breaks=1000)
#title(sub="DR - MamPhy 5911 spp, BDvrFixed - FBD, 10k trees")
#dev.off()
#pdf(file = "DRplot_BDvrFIXED_FBD_4098spp.pdf", height=8, width=8)
#hist(unlist(g_es_dr), breaks=1000)
#title(sub="DR - MamPhy 4098 spp, BDvrFixed - FBD, 10k trees")
#dev.off()
...
for(i in 1:ntrees) {
	...
	write.tree(phy_drop, "MamPhy_fullPosterior_BDvr_pcsFIXED_FBD_all10k_pruned4098spp.trees", append = TRUE)
	trees_drop[[i]] <- phy_drop
}

write.nexus(trees_drop, file="MamPhy_fullPosterior_BDvr_pcsFIXED_FBD_all10k_pruned4098spp_nexus.trees")
write.nexus(trees, file="MamPhy_fullPosterior_BDvr_pcsFIXED_FBD_all10k_nexus.trees")


trees_drop=scan("MamPhy_fullPosterior_BDvr_pcsFIXED_FBD_all10k_pruned4098spp.trees", what="",sep="\n",quiet=TRUE,skip=0,comment.char="#") 
...
write.table(g_es_dr_DROP, "DR-matrix_MamPhy_BDvrFIXED_FBD_all10k_pruned4098.txt")

pdf(file = "DRplot_BDvrFIXED_FBD_4098spp.pdf", height=8, width=8)
hist(unlist(g_es_dr_DROP), breaks=1000)
title(sub="DR - MamPhy 4098 spp, BDvrFixed - UNI, 10k trees")
dev.off()

###
# Now plot together...

pdf(file = "DRplot_BDvrFIXED_FBD_compare5911v4098spp.pdf", height=8, width=8)
hist(unlist(g_es_dr), breaks=1000, border="black")
hist(unlist(g_es_dr_DROP), breaks=1000, border="red")

title(sub="DR - MamPhy compare 5911 vs 4098 spp, BDvrFixed - FBD, 10k trees")
dev.off()
