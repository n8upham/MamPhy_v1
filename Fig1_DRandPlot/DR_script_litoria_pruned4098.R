...
write.table(g_es_dr, "DR-matrix_MamPhy_YuleCR_all10ktrees_pruned4098.txt")

pdf(file = "DRplot_4098spp.pdf", height=8, width=8, title="DR - MamPhy 5910 spp, Yule CR, 10k trees")
