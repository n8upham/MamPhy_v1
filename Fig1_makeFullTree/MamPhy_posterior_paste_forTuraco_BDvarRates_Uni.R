...
backbones <- read.nexus("postburn10k_Bbone_ND_60taxa_17calUni_BDallDNA.inMYR.trees")
...
write.tree(pasted_fulltree, "MamPhy_fullPosterior_BDvarRates_17Uni_all10k.trees", append = TRUE)
