...
nPred<-length(predictors)
	...
	#z=1
		form<-as.formula(paste(respVar[z], " ~ ", predictors[1], "+", predictors[2], "+", predictors[3], "+", predictors[4], "+", predictors[5], "+", predictors[6], "+", predictors[7], "+", predictors[8], "+", predictors[9], sep=""))  #
		...
		form<-as.formula(paste(respVar[z], " ~ ", predictors[1], "+", predictors[2], "+", predictors[3], "+", predictors[4], "+", predictors[5], "+", predictors[6], "+", predictors[7], "+", predictors[9], sep=""))
		model_8<-pgls(form, data=cladeData, lambda=1.0)

		form<-as.formula(paste(respVar[z], " ~ ", predictors[1], "+", predictors[2], "+", predictors[3], "+", predictors[4], "+", predictors[5], "+", predictors[6],  "+", predictors[8], "+", predictors[9], sep=""))
		model_7<-pgls(form, data=cladeData, lambda=1.0)

		form<-as.formula(paste(respVar[z], " ~ ", predictors[1], "+", predictors[2], "+", predictors[3], "+", predictors[4], "+", predictors[5], "+", predictors[7], "+", predictors[8], "+", predictors[9], sep=""))
		model_6<-pgls(form, data=cladeData, lambda=1.0)

		form<-as.formula(paste(respVar[z], " ~ ", predictors[1], "+", predictors[2], "+", predictors[3], "+", predictors[4], "+", predictors[6], "+", predictors[7], "+", predictors[8], "+", predictors[9], sep=""))
		model_5<-pgls(form, data=cladeData, lambda=1.0)

		form<-as.formula(paste(respVar[z], " ~ ", predictors[1], "+", predictors[2], "+", predictors[3], "+", predictors[5], "+", predictors[6], "+", predictors[7], "+", predictors[8], "+", predictors[9], sep=""))
		model_4<-pgls(form, data=cladeData, lambda=1.0)

		form<-as.formula(paste(respVar[z], " ~ ", predictors[1], "+", predictors[2], "+", predictors[4], "+", predictors[5], "+", predictors[6], "+", predictors[7], "+", predictors[8], "+", predictors[9], sep=""))
		model_3<-pgls(form, data=cladeData, lambda=1.0)

		form<-as.formula(paste(respVar[z], " ~ ", predictors[1], "+", predictors[3], "+", predictors[4], "+", predictors[5], "+", predictors[6], "+", predictors[7], "+", predictors[8], "+", predictors[9], sep=""))
		model_2<-pgls(form, data=cladeData, lambda=1.0)

		form<-as.formula(paste(respVar[z], " ~ ", predictors[2], "+", predictors[3], "+", predictors[4], "+", predictors[5], "+", predictors[6], "+", predictors[7], "+", predictors[8], "+", predictors[9], sep=""))
	...
	write.table(fullResALL, file=paste("cladeLevel",bbone,"_sample100_",i,"_PGLS_",corr,"_explaining-DR-MRCA_perSlice_",sliceN,"_multiANOVA_Correct-rootwardWithSingle_9preds.txt",sep=""))

	write.table(sumFull_paramsALL, file=paste("cladeLevel",bbone,"_sample100_",i,"_PGLS_",corr,"_explaining-DR-MRCA_perSlice_",sliceN,"_multiANOVA_Correct-rootwardWithSingle_9preds_tTable.txt",sep=""))
	write.table(sumFull_RSqsALL, file=paste("cladeLevel",bbone,"_sample100_",i,"_PGLS_",corr,"_explaining-DR-MRCA_perSlice_",sliceN,"_multiANOVA_Correct-rootwardWithSingle_9preds_RSqs.txt",sep=""))
