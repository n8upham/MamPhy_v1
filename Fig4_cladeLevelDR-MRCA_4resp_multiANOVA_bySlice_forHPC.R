...
nPred<-length(predictors)
	...
	write.table(fullResALL, file=paste("cladeLevel",bbone,"_sample100_",i,"_PGLS_",corr,"_explaining-DR-MRCA_perSlice_",sliceN,"_multiANOVA_Correct-rootwardWithSingle_8preds.txt",sep=""))

	write.table(sumFull_paramsALL, file=paste("cladeLevel",bbone,"_sample100_",i,"_PGLS_",corr,"_explaining-DR-MRCA_perSlice_",sliceN,"_multiANOVA_Correct-rootwardWithSingle_8preds_tTable.txt",sep=""))
	write.table(sumFull_RSqsALL, file=paste("cladeLevel",bbone,"_sample100_",i,"_PGLS_",corr,"_explaining-DR-MRCA_perSlice_",sliceN,"_multiANOVA_Correct-rootwardWithSingle_8preds_RSqs.txt",sep=""))
