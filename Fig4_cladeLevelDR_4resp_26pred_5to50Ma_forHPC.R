...
predictors<-c(paste("log",PRED_LOGvars,sep=""),PRED_NONvars)
...
write.table(uniPGLS,paste(bbone,"_sample100_",i,"_PGLS_",corr,"_explaining-",respVar[z],"_timeSlices_",sliceN,"_SCALED_uniVar_Correct_26preds.txt",sep=""))
