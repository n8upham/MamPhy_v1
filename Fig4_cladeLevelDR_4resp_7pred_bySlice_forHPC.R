...
predictors<-predictorsALL[c(1:7)] # just focusing on the 7 continuous predictors.
...
#		fit1<-gls(form, correlation=corBrownian(phy=cladeData$phy), data=dat, method="ML")
	...
	write.table(uniPGLS,paste(bbone,"_sample100_",i,"_PGLS_",corr,"_explaining-4varDR_perSlice_",sliceN,"_SCALED_uniVar_Correct_7preds.txt",sep=""))
