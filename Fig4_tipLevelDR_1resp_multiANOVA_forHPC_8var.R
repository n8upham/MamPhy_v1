...
PRED_names<-c(paste("log",c("HomeRange_km2","Trophic123", "GeoArea_km2", "GenLength_d", "Lifemode1234", "Activity123"),sep=""), PRED_NONvars,"genes") # "BodyMass_kg", "DispDist_km", 
...
#    -0.08442728      0.22009588 
	...
	write.table(fullResALL, file=paste("tipLevel",bbone,"_sample100_",i,"_PGLS_",corr,"_explaining-tipDR_multiANOVA_8preds.txt",sep=""))
