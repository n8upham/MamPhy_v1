...
allDatFinal<-cbind.data.frame(taxFinal[,c(1:5)],log(tipDR_i),log(tipDataAll[,PRED_LOGvars[1:2]]),log(tipDataAll[,PRED_LOGvars[3]]*tipDataAll[,PRED_LOGvars[4]]),log(tipDataAll[,PRED_LOGvars[5]]),tipDataAll[,PRED_NONvars],tipDataAll[,catsSelected])
...
#       0.34414994       -0.08442728        0.05511901        0.22009588 
		...
		form<-as.formula(paste(respVar, " ~ ", predictors[1], "+", predictors[2], "+", predictors[3], "+", predictors[4], "+", predictors[5], "+", predictors[6], "+", predictors[7], "+", predictors[8], sep=""))  #"+", predictors[9], 
		...
		form<-as.formula(paste(respVar, " ~ ", predictors[1], "+", predictors[2], "+", predictors[3], "+", predictors[4], "+", predictors[5], "+", predictors[6],  "+", predictors[8], sep=""))
		model_7<-pgls(form, data=cladeData, lambda=1.0)

		form<-as.formula(paste(respVar, " ~ ", predictors[1], "+", predictors[2], "+", predictors[3], "+", predictors[4], "+", predictors[5], "+", predictors[7], "+", predictors[8], sep=""))
		model_6<-pgls(form, data=cladeData, lambda=1.0)

		form<-as.formula(paste(respVar, " ~ ", predictors[1], "+", predictors[2], "+", predictors[3], "+", predictors[4], "+", predictors[6], "+", predictors[7], "+", predictors[8], sep=""))
		model_5<-pgls(form, data=cladeData, lambda=1.0)

		form<-as.formula(paste(respVar, " ~ ", predictors[1], "+", predictors[2], "+", predictors[3], "+", predictors[5], "+", predictors[6], "+", predictors[7], "+", predictors[8], sep=""))
		model_4<-pgls(form, data=cladeData, lambda=1.0)

		form<-as.formula(paste(respVar, " ~ ", predictors[1], "+", predictors[2], "+", predictors[4], "+", predictors[5], "+", predictors[6], "+", predictors[7], "+", predictors[8], sep=""))
		model_3<-pgls(form, data=cladeData, lambda=1.0)

		form<-as.formula(paste(respVar, " ~ ", predictors[1], "+", predictors[3], "+", predictors[4], "+", predictors[5], "+", predictors[6], "+", predictors[7], "+", predictors[8], sep=""))
		model_2<-pgls(form, data=cladeData, lambda=1.0)

		form<-as.formula(paste(respVar, " ~ ", predictors[2], "+", predictors[3], "+", predictors[4], "+", predictors[5], "+", predictors[6], "+", predictors[7], "+", predictors[8], sep=""))
	...
	write.table(fullResTIPS, file=paste("tipLevel_",bbone,"_sample100_",i,"_PGLS_",corr,"_explaining-tipDR_multiANOVA_8predsNoGenes.txt",sep=""))

	write.table(sumFull_params, file=paste("tipLevel_",bbone,"_sample100_",i,"_PGLS_",corr,"_explaining-tipDR_multiANOVA_8predsNoGenes_tTable.txt",sep=""))
	write.table(sumFull_RSqs, file=paste("tipLevel_",bbone,"_sample100_",i,"_PGLS_",corr,"_explaining-tipDR_multiANOVA_8predsNoGenes_RSqs.txt",sep=""))
